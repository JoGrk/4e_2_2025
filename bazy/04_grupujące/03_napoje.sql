...
SELECT 
    round(AVG(kalorie)) AS srednia_kalorycznosc,
    MAX(kalorie) AS maksymalna_kalorycznosc,
    MIN(kalorie) AS minimalna_kalorycznosc 
...
SELECT lod, round(AVG(kalorie)) AS srednia_kalorycznosc
FROM drinki_informacje
